...
; update environmentals
  ...
  if debug = "Scen" [
    ...
    ifelse day = year-start [
      ...
      set max-resources max-resources-base * (( yr-val + day-val ) * 2)
      let max-resources-cap max-resources
      if max-resources < 0.1 * max-resources-base [ set max-resources-cap 0.1 * max-resources-base ]
      ask resource-cells [ set resource-level  max-resources-cap ]
    ]
    [
      ;let res-delta max-resources-base * ( yr-val * 2 ) * day-val
      let res-delta ( day-val * 2 ) * max-resources-base
      ...
      ask resource-cells [
        ...
        if resource-level > max-resources-cap or max-resources-cap != max-resources [ set resource-level max-resources-cap ]
  ...
  let days-rec-abun [121 152 182 213 244 273]
