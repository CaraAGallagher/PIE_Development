...
ggplot(FullProjs, aes(x = floor_date, y = NDVI + 0.5, col = experiment, linetype = model)) +
...
year2023_2099 <- FullProjs %>% 
  filter(year(floor_date) == 2022 | year(floor_date) == 2039 | year(floor_date) == 2099) %>% 
...
ggsave("Figures/App 1/NDVI_585.png", height = 4, width = 10)

#write_csv(year2023_2099, "Data/Scenarios/VI GCM scenarios/Inputs/NDVI_hist_proj_245.csv")
#write_csv(year2023_2099, "Data/Scenarios/VI GCM scenarios/Inputs/NDVI_hist_proj.csv")
